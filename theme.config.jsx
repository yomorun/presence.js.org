...
const themeConfig = {
  ...
  docsRepositoryBase:
    "https://github.com/yomorun/presence.js.org/tree/gh-pages",
  useNextSeoProps() {
    return {
  ...
  logo: () => {
    return (
      <>
        <Logo height={24} />
        <span
          className="hidden mx-2 font-extrabold select-none md:inline"
          title="Allegro Cloud"
        >
          Presencejs
        </span>
  ...
  head: () => {
    ...
    const description =
      "Edge Infra for realtime web applications with Geo-distributed architecture";
    ...
    return (
      <>
        ...
        <meta
          ...
          content="vyCEWFzpKJ1zic0RiOREYpWWFtMKfqfFxcOYK64njrg"
        />
        <script
          async
          src="https://analytics.umami.is/script.js"
          data-website-id="af578941-ecba-48dc-8935-8935ba8ca0ff"
        ></script>
      </>
    );
  },
